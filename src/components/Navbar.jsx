          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <span className="sr-only">View notifications</span>
              <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 14l-3-3m0 0l-3 3m3-3v8a3 3 0 01-3 3h-2a3 3 0 01-3-3V8a3 3 0 013-3h2a3 3 0 013 3v6z" />
              </svg>
            </button>
            ...
            <div className="ml-3 relative">
              <div>
                <button type="button" className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img className="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/6128107?s=460&u=9c15f8ba5e4245f2009fde3074bf7e6a18b0427c&v=4" alt="" />
                </button>
              </div>
            </div>
          </div>
